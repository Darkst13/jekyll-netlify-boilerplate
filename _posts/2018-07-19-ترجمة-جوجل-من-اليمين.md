...
input{
     height:25px;width:350px;all: inherit; border-bottom: 2px solid #1a1f25;
}
select,
option,
input{
...
<form role="search" id="form" style="text-algin: right; position: relative;">
      <input type="search" id="query" name="q" placeholder="البحث..." aria-label="Search through site content" />
        <button style="all: unset;
        cursor: pointer;
        width: 44px; border-bottom: 2px solid #1a1f25;
