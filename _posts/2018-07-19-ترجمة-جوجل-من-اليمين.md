...
<input name="u" type="text" placeholder="الربط..." style="height:25px;width:350px;"/>
...
<input style="height:40px; width:190px; text-align: center;" name="submit" type="submit" value="ترجم"/>
</form>
