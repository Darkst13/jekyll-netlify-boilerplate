...
<input name="u" type="text" placeholder="الربط..." style="border-bottom: 2px solid #135721;"/>
...
<form role="search" id="form" style="text-algin: right; position: relative;">
      <input type="search" id="query" name="q" placeholder="الرابط..." style="border-bottom: 2px solid #135721;"/>
