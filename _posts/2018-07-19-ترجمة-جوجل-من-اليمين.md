...
<input style="height:40px; width:55px; text-align:center;border-bottom: 2px solid #135721;" name="submit" type="submit" value="ترجم"/>
</form>
...
<form role="search" id="form" style="text-algin: right; position: relative;">
      <input type="search" id="query" name="q" placeholder="الرابط..."/>
        ...
        cursor: pointer;
        width: 55px; border-bottom: 2px solid #135721;
