...
<form method="post" action="https://www.lexicool.com/ws-trans-execute.asp" target="_blank" style=" text-algin: right; position: relative;">
     <table>
          <tr><td colspan="2"><br/><strong>مترجم جوجل للاضافة:s</strong></td></tr>
          ...
          <tr><td><select style="display:flex; flex-direction: column; position:relative; width:350px; height:40px;" name="sl">
